...
urlpatterns = [
    ...
    path('remove-doctors/', views.remove_doctors, name='remove_doctors'),
    ...
    path('admin/blood-donation-admin/', views.blood_donation_admin_index, name='blood_donation_admin_index'),
    path('admin/blood-donation-admin/manage/', views.manage_blood_donation_admins, name='manage_blood_donation_admins'),
    path('admin/blood-donation-admin/add/', views.add_blood_donation_admin, name='add_blood_donation_admin'),

    path('blood-donation-dashboard/', views.blood_donation_dashboard, name='blood_donation_dashboard'),
]